...
export default new Vuex.Store({
  ...
  actions: {
    signUp({ commit, dispatch }, authData) {
      axiosAuth
        .post("accounts:signUp?key=AIzaSyAF1vTc49Gh7JblbYDvf9hMfURPqrs0FO0", {
    ...
    signIn({ commit }, authData) {
      axiosAuth
        .post(
          "accounts:signInWithPassword?key=AIzaSyAF1vTc49Gh7JblbYDvf9hMfURPqrs0FO0",
          {
            email: authData.email,
            password: authData.password,
            returnSecureToken: true
    ...
    storeUser({ state }, userData) {
      ...
      axios
        .post(
          "https://alia0021-final.firebaseio.com/users.json" +
            "?auth=" +
            state.idToken,
          userData
        )
    ...
    updateUser({ state }, userData) {
      axios
        ...
        .patch(
          "https://alia0021-final.firebaseio.com/users/" +
            state.user.id +
            ".json" +
            "?auth=" +
            state.idToken,
